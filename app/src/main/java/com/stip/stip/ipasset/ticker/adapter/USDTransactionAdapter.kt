package com.stip.stip.ipasset.ticker.adapter
...
// Using specific layout bindings for deposit and withdrawal
...
class USDTransactionAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            VIEW_TYPE_DEPOSIT -> {
                val binding = com.stip.stip.databinding.ItemUsdDepositTransactionBinding.inflate(
                    inflater, parent, false
                )
                DepositViewHolder(binding, onItemClick)
            }
            VIEW_TYPE_WITHDRAWAL -> {
                val binding = com.stip.stip.databinding.ItemUsdWithdrawalTransactionBinding.inflate(
                    inflater, parent, false
                )
    ...
    class DepositViewHolder(
        private val binding: com.stip.stip.databinding.ItemUsdDepositTransactionBinding,
    ...
    class WithdrawalViewHolder(
        private val binding: com.stip.stip.databinding.ItemUsdWithdrawalTransactionBinding,
