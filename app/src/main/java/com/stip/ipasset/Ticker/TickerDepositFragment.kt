...
import com.stip.stip.ipasset.Ticker.TickerDepositFragmentArgs
...
class TickerDepositFragment : BaseFragment<FragmentIpAssetTickerDepositBinding>() {
    ...
    private val navArgs: TickerDepositFragmentArgs by navArgs()
    ...
    private fun navigateToWithdrawal() {
        ...
        findNavController().navigate(
            ...
            TickerWithdrawalInputFragmentArgs(ipAsset).toBundle()
        )
    }
}
