 ...
 */
class USDWithdrawalTransactionDetailFragment : Fragment() {

    private var _binding: FragmentIpAssetUsdWithdralTransactionDetailBinding? = null
    private val binding get() = _binding!!
    
    // Navigation arguments
    private val args by navArgs<USDWithdrawalTransactionDetailFragmentArgs>()
    private lateinit var transaction: USDWithdrawalTransaction
    ...
    override fun onCreateView(
        ...
        _binding = FragmentIpAssetUsdWithdralTransactionDetailBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun displayTransactionDetails() {
        ...
        binding.tvTransactionType.text = "출금 완료"
        binding.tvAmount.text = "50.00 USD"
        binding.tvKrwAmount.text = "67,500 KRW"
