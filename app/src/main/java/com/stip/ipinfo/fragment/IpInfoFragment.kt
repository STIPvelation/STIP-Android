...
import com.stip.stip.databinding.FragmentIpInfoBinding

class IpInfoFragment : Fragment() {

    private lateinit var mainViewModel: com.stip.stip.MainViewModel

    private var _binding: FragmentIpInfoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentIpInfoBinding.inflate(inflater, container, false)
        return binding.root
    }
